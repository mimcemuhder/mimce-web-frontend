...
const BENEFITS = [
  {
    ...
    desc: 'Sektör profesyonelleriyle çalışarak hem teknik hem kişisel becerilerini geliştir.',
  },
  {
    icon: Users,
    title: 'Güçlü Ağ',
    desc: 'Yüzlerce mühendis, öğrenci ve profesyonelle tanışarak ağını genişlet.',
  },
  {
    icon: Heart,
    title: 'Anlam ve Amaç',
    desc: 'Emeğinin milletine dokunan bir amaca hizmet ettiğini hissederek çalış.',
  },
  {
    icon: Calendar,
    title: 'Etkinlik Deneyimi',
    desc: 'Ulusal ölçekli etkinliklerin organizasyonunda aktif rol al.',
  },
];
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="MİMCE'ye gönüllü olarak katılın. Eğitim, etkinlik, tanıtım ve topluluk birimlerinde görev alın."
        />
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-extrabold text-white leading-tight mb-5">
                Sen de Bu
                <br />
                <span className="text-primary">Ailenin Parçası</span>
                <br />
                Ol
              </h1>
              <p className="text-gray-400 text-base leading-relaxed max-w-md">
                MİMCE, tamamen gönüllülük esasıyla çalışan bir sivil toplum kuruluşudur. Emeğinle
                milletinin geleceğine katkı sağla.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-8">
              {sent ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      {AREAS.map(({ id, label, icon: Icon }) => {
                        ...
                        return (
                          ...
                          >
                            <div
                              className={`w-8 h-8 rounded-lg flex items-center justify-center shrink-0 ${selected ? 'bg-primary/15' : 'bg-gray-100'}`}
                            >
                              <Icon
                                size={15}
                                className={selected ? 'text-primary' : 'text-gray-400'}
                              />
                            </div>
                  ...
                  <button
                    type="submit"
                    disabled={loading || form.areas.length === 0}
