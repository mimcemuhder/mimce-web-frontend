...
const SectionHeader: React.FC<{
  ...
  <div className="flex items-end justify-between mb-8">
    ...
    {href && (
      <Link
        to={href}
        className="hidden sm:flex items-center gap-1.5 text-sm font-bold text-gray-500 hover:text-primary transition-colors"
      >
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="MİMCE, mühendislik öğrencileri ve profesyonellerini eğitim, etkinlik ve toplulukla buluşturan sivil toplum kuruluşudur."
        />
        <link rel="canonical" href="https://mimce.org/" />
        <meta property="og:title" content="MİMCE — Millî Mühendisler Cemiyeti" />
        <meta
          property="og:description"
          content="Eğitim, etkinlik ve toplulukla büyüyen mühendislik platformu."
        />
      ...
      <div className="w-full bg-white">
        ...
        <section className="relative w-full min-h-[580px] flex items-center overflow-hidden bg-navy">
          ...
          <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 w-full py-24 text-center">
            ...
            <p className="mt-6 text-base md:text-lg text-gray-400 leading-relaxed max-w-2xl mx-auto">
              Akademi ile sektör arasındaki köprüyü kuruyoruz. Eğitim, etkinlik ve topluluk
              desteğiyle mühendislerin gelişimine katkı sağlıyoruz.
            </p>
        ...
        <section className="py-14 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                {trainings.map((t) => (
                  ...
                  >
                    ...
                    <div className="p-4 flex flex-col flex-1">
                      <span className="font-mono text-[10px] font-bold text-primary tracking-wider mb-1">
                        {t.code}
                      </span>
                      <h3 className="text-sm font-bold text-navy leading-snug line-clamp-2 flex-1">
                        {t.title}
                      </h3>
            ...
            <div className="mt-4 sm:hidden text-center">
              <Link to="/egitimler" className="text-xs font-bold text-primary hover:underline">
                Tüm Eğitimleri Gör →
              </Link>
            </div>
          </div>
        ...
        <section className="py-14 bg-gray-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="mt-4 sm:hidden text-center">
              <Link to="/etkinlikler" className="text-xs font-bold text-primary hover:underline">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h2 className="text-2xl md:text-3xl font-extrabold text-navy leading-tight mb-4">
                Mühendislik Topluluğunun
                <br />
                Büyüme Platformu
              </h2>
              <p className="text-gray-500 leading-relaxed mb-4 text-sm">
                MİMCE; mühendislik öğrencileri ve profesyonelleri bir araya getirerek mentorluk,
                pratik beceri gelişimi ve sektör bağlantıları sunan bir ekosistem oluşturur.
              </p>
              <p className="text-gray-500 leading-relaxed mb-6 text-sm">
                Birlikte öğrenir, birlikte büyürüz. Her mühendis, kariyerinin her aşamasında doğru
                desteği hak eder.
              </p>
              <Link
                to="/hakkimizda"
              ...
              {[
                {
                  ...
                  desc: 'Sektörün ihtiyaçlarına göre tasarlanmış pratik eğitim programları.',
                },
                {
                  icon: Users,
                  title: 'Mentorluk Ağı',
                  desc: 'Deneyimli mühendislerden birebir kariyer rehberliği alın.',
                },
                {
                  icon: Calendar,
                  title: 'Topluluk Etkinlikleri',
                  desc: 'Networking, hackathon ve panel etkinlikleriyle ağınızı genişletin.',
                },
                {
                  icon: Award,
                  title: 'Sertifika Programları',
                  desc: 'Dijital sertifikalarla kazanımlarınızı belgeleyin ve paylaşın.',
                },
              ].map(({ icon: Icon, title, desc }) => (
                <div
                  key={title}
                  className="flex gap-4 p-4 rounded-xl border border-gray-100 bg-gray-50 hover:border-primary/20 hover:shadow-sm transition-all group"
                >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-gray-600 leading-relaxed text-sm mb-4">
                  MİMCE olarak mühendisliği yalnızca bir meslek değil; milletimize karşı kutsal bir
                  sorumluluk olarak görüyoruz. Teknolojiyi ve bilimi, millî ve manevî değerlerimizle
                  harmanlayarak geleceğe taşıyoruz.
                </p>
                <p className="text-gray-600 leading-relaxed text-sm">
                  Vatan sevgisi, dürüstlük ve topluma hizmet anlayışını mühendislik kimliğinin
                  ayrılmaz bir parçası kabul ederek yetişen nesillere örnek olmaya çalışıyoruz.
                </p>
              </div>
                ...
                {[
                  {
                    ...
                    desc: 'Bilgimizi ve üretimimizi önce vatanımızın kalkınmasına adıyoruz.',
                  },
                  {
                    icon: Heart,
                    title: 'Ahlâkî Temeller',
                    desc: 'Dürüstlük, alçakgönüllülük ve çalışkanlık mühendisimizin pusulasıdır.',
                  },
                  {
                    icon: Star,
                    title: 'Vatana Hizmet',
                    desc: 'Her proje, her eğitim; güçlü ve bağımsız bir Türkiye hedefine hizmet eder.',
                  },
                ].map(({ icon: Icon, title, desc }) => (
                  <div
                    key={title}
                    className="bg-white border border-gray-100 rounded-xl p-5 text-center hover:border-primary/20 hover:shadow-sm transition-all"
                  >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              <div className="rounded-2xl bg-gray-50 border border-gray-100 p-8 flex flex-col hover:shadow-md transition-shadow">
                ...
                <p className="text-sm text-gray-500 leading-relaxed flex-1 mb-6">
                  Eğitimler, atölyeler ve mentorluk programlarıyla kariyerine güçlü bir başlangıç
                  yap.
                </p>
                <Link
                  to="/egitimler"
                  className="inline-flex items-center gap-2 text-sm font-bold text-navy hover:text-primary transition-colors"
                >
              ...
              <div className="relative rounded-2xl bg-navy p-8 flex flex-col hover:shadow-lg transition-shadow overflow-hidden">
                ...
                <Link
                  to="/egitmen-ol"
                  className="inline-flex items-center gap-2 text-sm font-bold text-primary hover:text-primary-dark transition-colors relative z-10"
                >
                  ...
                  >
                    ...
                    <div className="p-5 flex flex-col flex-1">
                      {b.tags && b.tags.length > 0 && (
                        <span className="text-[10px] font-bold text-primary tracking-widest uppercase mb-1.5">
                          {b.tags[0]}
                        </span>
                      )}
                      <h3 className="font-bold text-navy text-sm leading-snug mb-2 line-clamp-2 flex-1">
                        {b.title}
                      </h3>
                      {b.excerpt && (
