  ...
  const socials = [
    {
      ...
      handle: '@mimcemuhder',
      icon: Instagram,
      url: 'https://instagram.com/mimcemuhder',
    },
    { label: 'X (Twitter)', handle: '@mimcemuhder', icon: XIcon, url: 'https://x.com/mimcemuhder' },
    {
      ...
      handle: '@mimcemuhder',
      icon: Youtube,
      url: 'https://youtube.com/@mimcemuhder',
    },
  ];
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="MİMCE ile iletişime geçin. Sorularınız, önerileriniz veya iş birliği talepleriniz için bize yazın."
        />
                ...
                <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-8">
                  {sent ? (
                    ...
                    <>
                      ...
                      <h2 className="text-xl font-extrabold text-navy mb-6">
