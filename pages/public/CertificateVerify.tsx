  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="MİMCE sertifikanızın geçerliliğini online olarak doğrulayın. Sertifika numaranızı girin."
        />
        <link rel="canonical" href="https://mimce.org/sertifika-dogrulama" />
        <meta property="og:title" content="Sertifika Doğrulama | MİMCE" />
        <meta
          property="og:description"
          content="MİMCE sertifikanızın geçerliliğini online olarak doğrulayın."
        />
          ...
          <div className="md:w-5/12 bg-navy p-8 flex flex-col justify-center relative overflow-hidden">
            ...
            <div className="relative z-10 text-center md:text-left">
              ...
              <p className="text-gray-300 leading-relaxed">
                MİMCE tarafından verilen sertifikaların orijinalliğini kontrol edin. Güvenilir ve
                şeffaf eğitim geçmişi.
              </p>
            </div>
          </div>
              ...
              {result.status === 'valid' && result.data && (
                <div className="bg-green-50 border border-green-200 rounded-lg p-4 animate-fade-in">
                  ...
                  <div className="mt-2 text-sm text-green-900 space-y-1">
                    <p>
                      <span className="font-semibold">Alıcı:</span> {result.data.recipientName}
                    </p>
                    <p>
                      <span className="font-semibold">Eğitim:</span> {result.data.courseName}
                    </p>
                    <p>
                      <span className="font-semibold">Tarih:</span> {result.data.issueDate}
                    </p>
                  </div>
                </div>
              )}
