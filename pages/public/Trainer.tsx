...
const BENEFITS = [
  {
    icon: Users,
    title: 'Topluluğa Erişim',
    desc: 'Yüzlerce öğrenci ve mühendisle buluşarak etkinizi yayın.',
  },
  {
    icon: Award,
    title: 'Sertifika & Tanınma',
    desc: 'Eğitimleriniz belgelenir, profiliniz topluluğumuzda paylaşılır.',
  },
  {
    icon: Globe,
    title: 'Ulusal Platform',
    desc: 'Türkiye genelinde mühendislik camiasında ses getirin.',
  },
  {
    icon: GraduationCap,
    title: 'Bilgiyi Aktarın',
    desc: 'Deneyiminizi paylaşarak yeni nesil mühendislere yol gösterin.',
  },
];
...
const Trainer: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setError(null);
    try {
      const { error: dbError } = await supabase.from('trainer_applications').insert([
        {
          name: form.name,
          email: form.email,
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="MİMCE Eğitmen Programı'na katılın. Sektör deneyiminizi ve uzmanlığınızı paylaşarak mühendis adaylarına yol gösterin."
        />
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-extrabold text-white leading-tight mb-5">
                Bilginizi
                <br />
                <span className="text-primary">Geleceğe</span>
                <br />
                Aktarın
              </h1>
              <p className="text-gray-400 text-base leading-relaxed max-w-md">
                Sektör deneyiminizi ve uzmanlığınızı paylaşarak mühendis adaylarının kariyer
                yolculuğuna katkı sağlayın.
              </p>
            </div>
              ...
              {[
                {
                  step: '01',
                  title: 'Başvurun',
                  desc: 'Formu doldurun, uzmanlık alanınızı ve eğitim önerinizi paylaşın.',
                },
                {
                  step: '02',
                  title: 'Değerlendirme',
                  desc: 'Ekibimiz başvurunuzu inceler, sizi arayarak detayları görüşür.',
                },
                {
                  step: '03',
                  title: 'Eğitimi Verin',
                  desc: 'Müfredat belirlenir, tarih ayarlanır ve eğitiminiz yayına alınır.',
                },
              ].map(({ step, title, desc }) => (
                <div
                  key={step}
                  className="text-center p-6 rounded-2xl border border-gray-100 hover:border-primary/20 hover:shadow-sm transition-all"
                >
              ...
              {sent ? (
                <div className="flex flex-col items-center justify-center py-12 text-center">
                  ...
                  <p className="text-gray-500 text-sm max-w-xs leading-relaxed mb-6">
                    Ekibimiz başvurunuzu inceleyecek ve 3–5 iş günü içinde size ulaşacak.
                    Teşekkürler!
                  </p>
                  <button
                    onClick={() => {
