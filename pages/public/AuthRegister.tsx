      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 flex items-center justify-center p-4">
        <div className="max-w-md w-full bg-white rounded-2xl shadow-xl overflow-hidden">
          <div className="bg-navy p-8 text-center">
            <Link to="/">
              <img src="/mimce_logo.svg" alt="MİMCE Logo" className="h-10 mx-auto mb-4 brightness-0 invert" />
            </Link>
            <h1 className="text-2xl font-bold text-white">Kayıt Başarılı!</h1>
          </div>
          <div className="p-8 text-center space-y-4">
            ...
            <Link
              to="/giris"
              className="inline-block px-6 py-2.5 bg-primary text-navy font-bold rounded-lg hover:bg-primary-dark transition-colors"
            >
              Giriş Sayfasına Dön
            </Link>
          </div>
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 flex items-center justify-center p-4">
      <div className="max-w-md w-full bg-white rounded-2xl shadow-xl overflow-hidden">
        <div className="bg-navy p-8 text-center">
          ...
          <p className="text-gray-300 text-sm mt-2">MİMCE topluluğuna katılın</p>
        </div>
