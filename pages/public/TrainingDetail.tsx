          ...
          <div className="flex flex-col md:flex-row gap-10 items-start">
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="flex flex-wrap items-center gap-2 mb-4">
                ...
                <span className={`text-xs font-bold px-2.5 py-1 rounded-full ${typeColors[training.type] ?? 'bg-gray-100 text-gray-600'}`}>
                  {training.type}
                </span>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 mb-6">
                <div className="bg-gray-50 rounded-xl p-3">
                  <div className="text-[10px] text-gray-400 font-semibold uppercase tracking-wider mb-1">Tarih</div>
                ...
                <div className="bg-gray-50 rounded-xl p-3">
                  <div className="text-[10px] text-gray-400 font-semibold uppercase tracking-wider mb-1">Kategori</div>
                  <div className="flex items-center gap-1.5 text-sm font-bold text-navy">
                ...
                <div className="bg-gray-50 rounded-xl p-3">
                  <div className="text-[10px] text-gray-400 font-semibold uppercase tracking-wider mb-1">Sertifika</div>
                  <div className="flex items-center gap-1.5 text-sm font-bold text-navy">
                ...
                {[
                  ...
                  <div key={i} className="flex items-center gap-4 p-4 bg-gray-50 rounded-xl border border-gray-100">
                    ...
                    <div className="flex-1">
                      <div className="text-[10px] text-primary font-semibold uppercase tracking-wider">{mod.week}</div>
        ...
        {isCompleted && (
          <div className="bg-gray-100 rounded-2xl border border-gray-200 p-8 text-center">
            ...
            <p className="text-sm text-gray-500">
              ...
              {' '}<Link to="/egitimler" className="text-primary font-semibold hover:underline">eğitimler sayfasına</Link> dönebilirsiniz.
            </p>
          </div>
        )}
        ...
        {related.length > 0 && (
          <div className="pt-6">
            <div className="flex items-center justify-between mb-5">
              ...
              <Link to="/egitimler" className="text-primary font-semibold text-sm flex items-center gap-1 hover:gap-2 transition-all">
              ...
              {related.map(rel => (
                ...
                >
                  ...
                  <div className="min-w-0">
                    {rel.code && (
                      <span className="font-mono text-[10px] font-bold text-primary">{rel.code}</span>
                    )}
                    <h3 className="font-bold text-navy text-sm leading-snug line-clamp-2 mt-0.5">{rel.title}</h3>
